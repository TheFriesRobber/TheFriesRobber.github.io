...
## 问题
Apache Spark 应用的架构是什么样的？和 MapReduce 有什么区别？Apache Spark 应用是如何利用 YARN 进行管理的？
...
<figure>
  <img
  src="/posts/spark-yarn-cluster-mode.png"
...
<figure>
  <img
  src="/posts/spark-yarn-client-mode.png"
...
- 可以利用YARN的scheduler[^2]做分类，隔离和设置优先级。
